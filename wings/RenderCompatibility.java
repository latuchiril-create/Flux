...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "dile.safeWorldEffects";
    private static final String SAFE_WORLD_EFFECTS_ENV = "RELEON_SAFE_WORLD_EFFECTS";

    private static Boolean disableFragEffectScanShader;
    private static String disableFragEffectScanShaderReason = "unresolved";
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "dile.disableFragEffectScanShader";
    private static final String DISABLE_FRAG_EFFECT_SCAN_ENV = "RELEON_DISABLE_FRAG_EFFECT_SCAN_SHADER";
